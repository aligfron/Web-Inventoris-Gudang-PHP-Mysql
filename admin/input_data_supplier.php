<html>
<head><title>Input Data Supplier</title>
...
style="background-color : rgba(167,167,167,0.3); 
     ...
     ">
<br>
<center><h2>MASUKKAN DATA SUPPLIER</h2>
<form method="post" action="proses_input_supplier.php">
<table>
<tr>
  <td>Nama Supplier</td>
  <td>:</td>
...
<tr>
  <td>Alamat</td>
  <td>:</td>
  <td> <input type="text" name="alamat" autocomplete="off" required></td>
</tr>
<tr>
  <td>No Telp</td>
  <td>:</td>
  <td> <input type="text" name="no_tlp" autocomplete="off" required></td>
</tr>
<tr>
  <td>Nama Seles</td>
  <td>:</td>
  <td> <input type="text" name="nama_seles" autocomplete="off" required></td>
</tr>
