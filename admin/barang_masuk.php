...
style="background-color : rgba(167,167,167,0.3); 
     ...
     ">
  <br>
 <h3 align="center"><strong>TRANSSAKSI BARANG MASUK</strong></h3>
<?php 
...
echo $_SESSION['nama'];
 ...
 ?>
 <br>
 <a href="input_barang_baru.php?nama=<?php echo $_SESSION['nama']; ?>" ><button type="button" class="btn btn-outline-primary">MASUKKAN BARANG BARU</button></a>
 <table align="right">
  <a href="input_stok.php?nama=<?php echo $_SESSION['nama']; ?>" ><button type="button" class="btn btn-outline-primary">TAMBAH STOK SAJA</button></a>

 <br><br>
<table border="2" width="100%" align="center">
  <tr align="center">
    <td><strong>No</td>
    <td><strong>Kode Transsaksi Masuk</td>
    <td><strong>Tanggal Masuk</td>
    <td><strong>Jam Masuk</td>
    <td><strong>Nama Supplier</td>
    <td><strong>Stok Yang Masuk</td>
    <td><strong>Nama Barang</td>
    <td><strong>Total Stok</td>
    <td><strong>Satuan</td>
    <td><strong>Nama Petugas</td>
  </tr>
  <?php 
  $no = 1;
  $sql=mysqli_query($koneksi, "SELECT * FROM barangmasuk order by id_masuk desc limit 3 ");
  ...
  <tr>
    ...
    <td align="center"><?php echo $re['id_masuk']; $kod = $re['id_masuk']; ?></td>
    <td align="center"><?php echo $re['tgl_masuk']; ?></td>
    <td align="center"><?php echo $re['jam']; ?></td>
    <td align="center"><?php echo $re['nama_supplier']; ?></td>
    <td align="center"><?php echo $re['stokmasuk']; ?></td>
    <td align="center"><?php echo $re['nama_barang']; ?></td>
    <td align="center"><?php echo $re['total_stok']; ?></td>
