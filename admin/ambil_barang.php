...
<tr>
    <td>Nama Barang </td>
    <td>&nbsp;:&nbsp;</td>
    <td><input type="text" name="nama" autocomplete="off" value="" >
...
<tr>
  <td>Pengambil</td>
  <td>:</td>
  <td> <input type="text" name="stok" autocomplete="off" required readonly></td>
</tr>
<tr>
  <td>Divisi</td>
  <td>:</td>
  <td> <input type="text" name="ptgs" autocomplete="off" value="" readonly></td>
</tr>
<tr>
  <td>Id Barang</td>
  <td>:</td>
  <td> <input type="text" name="tgl" autocomplete="off" value="" ></td>
</tr>
<tr>
  <td>Jam</td>
  <td>:</td>
  <td> <input type="text" name="jam" autocomplete="off" value="" ></td>
</tr>
<tr>
  <td>Stok</td>
  <td>:</td>
